...
function phone_link_sc($atts, $content = null) {
	...
	if ($phone) :
		$output = '<a href="tel:' . $phone . '" class="contact-phone">' . $phone . '</a>';
	else:
		$output = '';
	endif;
...
function contact_email_sc($atts, $content = null) {
	...
	if ($email) :
		$output = '<a href="mailto:' . $email . '" class="contact-email">' . $email . '</a>';
	else:
		$output = '';
	endif;
...
function contact_address_sc($atts, $content = null) {
	...
	if ($location_text && $location_link) :
		$output = '<a href="' . $location_link . '" class="contact-address" target="_blank">' . $location_text . '</a>';
	else:
		$output = '';
	endif;
