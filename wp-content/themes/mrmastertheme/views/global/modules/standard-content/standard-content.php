...
if ($content_rows) :
    ...
    foreach ($content_rows as $content_row) {
        ...
        $row_class = $content_row['row_class'];

        //depending on the column count, grab the right template file: 
        echo get_template_part('views/global/modules/standard-content/layout-options/' . $column_count . '-column', null, array('content_row' => $content_row, 'text_color_attribute' => $text_color_attribute, 'row_class' => $row_class));
    }
?>
