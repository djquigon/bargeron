...
<div class="thumbnails-row">
    <div class="container">
        <ul class="gallery-thumbnails">
            ...
            ?>
                    <li>
                        <?= get_template_part('views/global/components/media-gallery/components/masonry-thumbnail-button', null, $template_args) ?>
                    </li>
            <?php
                    $count++;
                endforeach;
        ...
        <div id="masonry-gallery-<?= $random_integer ?>">
            <?php
                foreach ($media_gallery as $slide) {
                    ...
                    echo get_template_part('views/global/components/media-gallery/components/masonry-slide', null, $template_args);
                }
            ?>
        </div>
