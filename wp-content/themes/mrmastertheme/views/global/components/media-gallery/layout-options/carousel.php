...
<div class="slider-main-row container">
    <div id="slider-main-<?= $random_integer ?>">
        ...
        ?>
                ...
                >
                    <?= get_template_part('views/global/components/media-gallery/components/carousel-slide', null, $template_args) ?>
                </figure>
        <?php
            endforeach;
        ?>
            ...
            >
                ...
                ?>
                        <div class="thumbnail-slide">
                            <?= get_template_part('views/global/components/media-gallery/components/carousel-thumbnail-button', null, $template_args) ?>
                        </div>
                <?php
                        $count++;
                    endforeach;
