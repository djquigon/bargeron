...
if (isset($args['bio_options'])) {
    ...
    $display_full_bio = $bio_options['display_full_bio_or_view_bio_button'];
    $display_view_bio_button = !$bio_options['display_full_bio_or_view_bio_button'];
    $bio_button_options = $bio_options['bio_button_options'];
} else {
        ...
        <?php if ($bio) : ?>
            ...
            <?php if ($display_view_bio_button) : ?>
                ...
                <?php elseif ($bio_button_options === 'modal') : ?>
                    ...
                    <?php
                    get_template_part('views/conditional/team/archive/modules/team-members/components/modal-bio', null, array(
                        'member' => $member
                    ));
                    ?>
                <?php endif; ?>
